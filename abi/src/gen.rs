...
///
/// ONLY looks up from the typed constants map (genDict.constants).
...
pub fn gen_abi_call_m<R: Rng>(
    ...
    crate::mutate::mutate_call_enhanced(rng, &call_name, &args)
}
